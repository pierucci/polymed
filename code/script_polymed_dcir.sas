...
CASE 
       WHEN ER_PRS_F.exe_soi_amd IN (&m1, &m2, &m3) THEN '1'
       WHEN ER_PRS_F.exe_soi_amd IN (&m4, &m5, &m6) THEN '2'
       WHEN ER_PRS_F.exe_soi_amd IN (&m7, &m8, &m9) THEN '3'
       WHEN ER_PRS_F.exe_soi_amd IN (&m10, &m11, &m12) THEN '4'
       ELSE ER_PRS_F.exe_soi_amd
END 
%MEND ;
...
%MACRO l2n(x) ;
/* transforme logique en numérique pour ORACLE */
